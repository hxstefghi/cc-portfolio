          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button 
                ...
                className="px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-sm font-medium rounded-lg hover:bg-gray-700 dark:hover:bg-gray-100 transition-all hover:shadow-lg"
              >
                View Projects
              </button>
              <a 
